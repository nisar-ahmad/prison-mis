...
namespace PRSFingerIdentify
{
    class HelperFunctions
    {
        ...
        public static string[] GetAllPrisonerIds
        {
        ...
        public static string connectionString = @"Data Source=(local)\SQLEXPRESS; Initial Catalog=UNODCPRS; User ID=sa; Password=sa123;";
        ...
        public static int ConnectDBnExecuteScript(string Script)
        {
            int count = 0;
        ...
        {
            string allUsers = "SELECT PrisonerId, FMD1 FROM Prisoners WHERE FMD1 IS NOT NULL";
